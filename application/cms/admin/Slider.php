    ...
    public function index()
    {
        ...
        return ZBuilder::make('table')
            ...
            ->addColumns([ // 批量添加数据列
                ['id', 'ID'],
                ['cover', '图片', 'picture'],
                ['cn_title', '中文标题', 'text.edit'],
                ['cn_desc', '中文短语', 'text.edit'],
                ['en_title', '英文标题', 'text.edit'],
                ['en_desc', '英文短语', 'text.edit'],
                ['url', '链接', 'text.edit'],
    ...
    public function add()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($slider = SliderModel::create($data)) {
                // 记录行为
                action_log('slider_add', 'cms_slider', $slider['id'], UID, $data['en_title']);
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (SliderModel::update($data)) {
                // 记录行为
                action_log('slider_add', 'cms_slider', $id, UID, $data['en_title']);
